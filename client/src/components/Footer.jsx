...
const Footer = () => {
  return (
        <footer className='bg-black text-white font-bold text-center p-4 mt-0'>
          <div className='flex flex-wrap max-lg:flex-col max-lg:justify-start max-lg:items-start justify-between items-start gap-20 mx-5 lg:mx-20'>
          ...
          <div className='flex justify-between text-white-400 mt-10 max-sm:flex-col max-sm:items-center max-sm:gap-4'>
